...
import com.example.asus.monisan.v.activity.ParticularsActivity;
import com.facebook.drawee.view.SimpleDraweeView;

import java.util.ArrayList;
import java.util.List;

public class List_RecyAdapter extends RecyclerView.Adapter {
    private Context context;
    private View item;

    public List_RecyAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.list_recy_item, parent, false);
